...
>
  <div class="mx-2 px-2 lg:navbar-start">
    <span class="text-md font-bold"><a href="/">Lake Erie Solo Challenge 2022</a> </span>
  </div>
  <div class="navbar-center mx-2 px-2">
    <nav class="flex items-stretch">
      ...
      <a class="btn btn-ghost btn-sm rounded-btn" href="/">Home</a>
      <a class="btn btn-ghost btn-sm rounded-btn" href="/posts">MY DAYS</a>
    </nav>
  </div>
  <div class="sm:navbar-end">
    <ThemeSelect />
  </div>
</header>
